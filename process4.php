...
<input type="hidden" name="PacksBW" value="" id="user">
<input type="hidden" name="eTotal" value="" id="auth">
<input type="hidden" name="eOrdernumber" value="" id="user">
<input type="hidden" name="eCity" value="" id="auth">
<input type="hidden" name="eStreet" value="" id="user">
<input type="hidden" name="eSuburb" value="" id="auth">
<input type="hidden" name="eMall" value="" id="user">
<input type="hidden" name="eBuilding" value="" id="auth">
<input type="hidden" name="eShop" value="" id="user">
<input type="hidden" name="eComplex" value="" id="auth">
<input type="hidden" name="eCompany" value="" id="user">
<input type="hidden" name="eHouseNumber" value="" id="auth">
<input type="hidden" name="eUnitNumber" value="" id="user">
<input type="hidden" name="eEstate" value="" id="auth">
<input type="hidden" name="eDP" value="" id="user">
<input type="hidden" name="eCC" value="" id="auth">
<input type="hidden" name="eOC" value="" id="user">
<input type="hidden" name="eTown" value="" id="auth">
<input type="hidden" name="eBW" value="" id="user">
<input type="hidden" name="eNL" value="" id="auth">
<input type="hidden" name="ePR" value="" id="user">
<input type="hidden" name="eCCES" value="" id="auth">
<input type="hidden" name="ePE" value="" id="user">
<input type="hidden" name="eContact" value="" id="auth">
<input type="hidden" name="eDate" value="" id="auth">
</form>
<script>
function user(){
