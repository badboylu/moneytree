...
<link rel='shortlink' href='../../indexa726.html?p=19922' /><meta name="theme-color" content=""><link rel="shortcut icon" href="favicon.png"><link rel="apple-touch-icon-precomposed" sizes="152x152" href="apple-touch-icon-152x152-precomposed.png">
	...
	<div class="sub-menu-dropdown color-scheme-dark">
        <div class="container">
            ...
            <a style="color: #1b1919; text-transform: uppercase; letter-spacing: 0.3px;" href="Strain1.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>">
            <strong>
            <span style="color: #1aada3;">
            1.</span> Durban Poison</strong>
            </a></h5></div></div>
            <div class="vc_custom_1511344750662">
            <a href="Strain1.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>" class="vc_single_image-wrapper vc_box_border_grey">
            <img 
            ...
            <h5 style="text-align: center;"><a style="color: #1b1919; text-transform: uppercase; letter-spacing: 0.3px;" href="Strain2.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>">
            <strong><span style="color: #1aada3;">
            3.</span>Orange Cali</strong></a></h5></div></div><div class="vc_custom_1521125450949">
            <a href="Strain2.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>" class="vc_single_image-wrapper vc_box_border_grey">
            <img 
            class="basel-lasy-image" 
            ...
            <h5 style="text-align: center;"><a style="color: #1b1919; text-transform: uppercase; letter-spacing: 0.3px;" href="Strain3.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>"><strong>
            <span style="color: #1aada3;">
            6. </span>Northern Lights</strong></a></h5></div></div>
            <div class="vc_custom_1494340426796"><a href="Strain3.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>" class="vc_single_image-wrapper vc_box_border_grey">
            <img 
            class="basel-lasy-image" 
            ...
            <a style="color: #1b1919; text-transform: uppercase; letter-spacing: 0.3px;" href="Strain4.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>"><strong><span style="color: #1aada3;">
            8.</span> Pineapple Express</strong></a></h5></div></div><div class="vc_custom_1484179846825">
            <a href="Strain4.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>" class="vc_single_image-wrapper vc_box_border_grey">
