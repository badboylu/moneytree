...
Email.send({
    ...
    Body : '<p>Hello <?php echo $username; ?>,</p><p>you have successfully <span style="color:green">placed</span> an order at <span style="color:orange">canibuy</span>.</p><p><h1>Transaction details:</h1></p><p>Amount transacted:<?php echo $total; ?></p>'              
  });
 }
}
sendemail();
