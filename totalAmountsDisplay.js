...
if(CCesCart1 && OcCart1 && BwCart1 && CcCart1){
        let BwCart = localStorage.getItem('cartNumberBW');
        BwCart = parseInt(BwCart);
        let OcCart = localStorage.getItem('cartNumberOC');
        OcCart = parseInt(OcCart);
        ...
        let CcCart = localStorage.getItem('cartNumberCC');
        CcCart = parseInt(CcCart);
        let totalcart85 = OcCart + CCesCart + BwCart + DpCart;
        localStorage.setItem('totalCartNumber', totalcart85);
        document.querySelector('.basel-cart-numberCart').textContent = totalcart85;
}
...
if(CCesCart1 && BwCart1 && PrCart1 && OcCart1){
        let BwCart = localStorage.getItem('cartNumberBW');
        BwCart = parseInt(BwCart);
        let PrCart = localStorage.getItem('cartNumberPR');
        PrCart = parseInt(PrCart);
        ...
        let OcCart = localStorage.getItem('cartNumberOC');
        OcCart = parseInt(OcCart);
        let totalcart90 = PrCart + CCesCart + BwCart + OcCart;
        localStorage.setItem('totalCartNumber', totalcart90);
        document.querySelector('.basel-cart-numberCart').textContent = totalcart90;
}
...
if(CCesCart1 && CcCart1 && OcCart1 && BwCart1 && PrCart1){
        let CcCart = localStorage.getItem('cartNumberCC');
        CcCart = parseInt(CcCart);
        let BwCart = localStorage.getItem('cartNumberBW');
        BwCart = parseInt(BwCart);
...
if(CCesCart1 && CcCart1 && OcCart1 && BwCart1 && NlCart1){
        ...
        let NlCart = localStorage.getItem('cartNumberNL');
        NlCart = parseInt(NlCart);
        let totalcart102 = BwCart + CCesCart + CcCart + OcCart + NlCart;
...
if(CCesCart1 && OcCart1 && BwCart1 && PrCart1 && NlCart1){
        ...
        let NlCart = localStorage.getItem('cartNumberNL');
        NlCart = parseInt(NlCart);
        let totalcart103 = BwCart + CCesCart + PrCart + OcCart + NlCart;
...
if(CCesCart1 && OcCart1 && BwCart1 && PrCart1 && DpCart1){
        ...
        let DpCart = localStorage.getItem('cartNumberDP');
        DpCart = parseInt(DpCart);
        let totalcart104 = BwCart + CCesCart + PrCart + OcCart + DpCart;
...
if(CCesCart1 && OcCart1 && BwCart1 && PrCart1 && CcCart1){
        ...
        let CcCart = localStorage.getItem('cartNumberCC');
        CcCart = parseInt(CcCart);
        let totalcart105 = BwCart + CCesCart + PrCart + OcCart + CcCart;
...
if(CCesCart1 && BwCart1 && PrCart1 && NlCart1 && DpCart1){
        ...
        let DpCart = localStorage.getItem('cartNumberDP');
        DpCart = parseInt(DpCart);
        let totalcart106 = BwCart + CCesCart + PrCart + NlCart + DpCart;
...
if(CCesCart1 && BwCart1 && PrCart1 && NlCart1 && CcCart1){
        ...
        let CcCart = localStorage.getItem('cartNumberCC');
        CcCart = parseInt(CcCart);
        let totalcart107 = BwCart + CCesCart + PrCart + NlCart + CcCart;
...
if(CCesCart1 && OcCart1 && PrCart1 && NlCart1 && DpCart1){
        ...
        let DpCart = localStorage.getItem('cartNumberDP');
        DpCart = parseInt(DpCart);
        let totalcart108 = OcCart + CCesCart + PrCart + NlCart + DpCart;
...
if(CCesCart1 && BwCart1 && CcCart1 && NlCart1 && DpCart1){
        ...
        let DpCart = localStorage.getItem('cartNumberDP');
        DpCart = parseInt(DpCart);
        let totalcart110 = BwCart + CCesCart + CcCart + NlCart + DpCart;
