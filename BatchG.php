...
<a href="Items.php?auth=<?php echo $_GET['auth'];?>" rel="v:url" property="v:title">
Items
</a> 
<span class="current">
	Sour Diesel 
...
<span><strong>Batch G selected [<a href="Donor.php?auth=<?php echo $_GET['auth'];?>">Donate</a>] </strong></span>
</div>
</div>
</div>
...
Contact us <a href="C.php?auth=<?php echo $_GET['auth'];?>">[Here]</a></div></div></div></div></footer></div>
